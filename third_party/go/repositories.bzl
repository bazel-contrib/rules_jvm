...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:jSI1//ahBQUqMj1fefIUcKufXTutq1N8r12L0oll+a4=",
        version = "v0.0.0-20220727195344-9ed9ecb0092c",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:6MHJ6YxMDr/dhS4mnM3sZxmolqgJw36ibOtwXNHTo6M=",
        version = "v0.0.0-20220503232738-6eb133c65a13",
    )
    go_repository(
