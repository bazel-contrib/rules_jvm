...
/**
 * Level 2 inline functions - these call other inline functions AND use their own dependencies. This
 * tests transitive inline function calls.
 */
object Level2 {

  /**
   * Inline function that calls another inline function (createList) AND uses Gson. This should
   * cause transitive dependencies from both:
