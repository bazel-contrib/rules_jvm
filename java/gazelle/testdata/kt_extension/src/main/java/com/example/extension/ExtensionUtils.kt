...
/**
 * Simple extension function that uses Gson library. This should cause any code that calls this
 * function to depend on Gson classes.
 */
...
/**
 * Simple extension function with no external dependencies. This should not add any extra
 * dependencies to calling code.
 */
