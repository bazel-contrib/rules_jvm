...
/**
 * Multiple inline functions with different dependency patterns.
 * This tests the system's ability to handle multiple inline functions
 * in the same file with different transitive dependencies.
 */
