...
/**
 * Class with multiple property delegates using different external dependencies.
 * This should export all the dependencies used by the delegates:
...
class MultipleDelegates {
     ...
     */
    val stringProcessor: String by lazy {
     ...
     */
    var dataMap: Map<String, String> by Delegates.observable(emptyMap<String, String>()) { _, _, newValue ->
     ...
     */
    var validatedJson: String by Delegates.vetoable("{}") { _, _, newValue ->
