...
/**
 * Consumer that uses property delegates from another package. This should automatically get
 * transitive dependencies from the provider's delegates through the exports mechanism.
 */
class Consumer {
