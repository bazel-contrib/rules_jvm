...
class PerClassData {
    ...
    public void merge(PerClassData other) {
      ...
      for (Map.Entry<String, SortedSet<String>> methodAndAnnotations : other.perMethodAnnotations.entrySet()) {
      ...
      for (Map.Entry<String, SortedSet<String>> fieldAndAnnotations : other.perFieldAnnotations.entrySet()) {
