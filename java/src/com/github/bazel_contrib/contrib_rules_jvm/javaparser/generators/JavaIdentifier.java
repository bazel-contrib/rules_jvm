...
public class JavaIdentifier implements Comparable<JavaIdentifier> {
   ...
   * artifact("com.example.library:library") - For a dependency external to the repo and found in
   * the maven cache - //src/java/com/example/library - For a dependency in the repo the root of thw
   * source tree for searching - null - For all dependencies in the default java library or from
   * generated code
   */
